...
const kPrimaryColor2 = Color(0xFF821C1A);
final kPrimaryColor3 = Color(0xFFFFA4A2);
const kPrimaryColor8 = Color(0xFF9D1A17);
final kPrimaryColor7 = Color(0xFFBE1B17);
const kPrimaryColor6 = Color(0xFFE53935);
const kPrimaryColor5 = Color(0xFFF5423E);
final kPrimaryColor4 = Color(0xFFFD6F6C);
...
const kFontText = Color(0xFF1E293B);
const kFontText2 = Color(0xFFF8FAFC);
const kFontText3 = Color(0xFFF1F5F9);
const kFontText4 = Color(0xFFE2E8F0);
const kFontText5 = Color(0xFF94A3B8);
const kFontText6 = Color(0xFF64748B);
const kFontText7 = Color(0xFF475569);
const kFontText8 = Color(0xFF334155);
...
const kContainerBackgroundGradeintColor = LinearGradient(
  colors: [Color(0xFFFF9A5A), Color(0xFFF94F4F)], // Light orange to red
